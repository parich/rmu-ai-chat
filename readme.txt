...
= 1.1.2 =
* ปุ่ม "ตรวจสอบอีกครั้ง" (force-check) ข้าม cache 6 ชั่วโมงของ update checker แล้ว — เห็น release ใหม่ทันที
* ล้าง cache ของ update checker อัตโนมัติหลังอัปเดตปลั๊กอินสำเร็จ
